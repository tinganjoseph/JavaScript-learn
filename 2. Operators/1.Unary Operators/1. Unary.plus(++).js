 ...
 * * a = +a; // 10;
 * 
 * todo: if the value is a number, the unary plus operator does not take any effect.
 * todo: Note: In case you apply the unary plus on a non-numeric value, it performs the same conversion as the Number() function.
 * 
 * !example:
 */
let s ="10";
